...
function App() {
  ...
  function renderModal() {
    if (isModalOpen) {
      return (
        <>
          <Modal postInfo={postInfo[postIndex]}
  ...
  function renderPost(postInfo, postIndex) {
    return (
      <>
        <Post
  ...
  return (
    <>
          ...
          <div className="name_options">
            ...
            <div className="options">
              <button
                className="buttons"
                onClick={() => {
                  setHasUserFollowed(!hasUserFollowed);
                  addRemoveFollower();
                }}
                style={{
                  background: hasUserFollowed ? "darkgray" : "lightblue",
                }}
              >
                {hasUserFollowed ? "Following" : "Follow"}
              </button>
      ...
      <div className="profile">{postInfo.map(renderPost)}</div>
